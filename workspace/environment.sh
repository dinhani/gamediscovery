...
export GD_DATA_RAW=F:/gamediscovery/data/raw
...
export GD_DATA_PARSED=F:/gamediscovery/data/parsed
...
export GD_DATA_NEO4J=F:/gamediscovery/neo4j

# Directory where Lucene index are stored
# It is generated from the Neo4J database
export GD_DATA_LUCENE=F:/gamediscovery/lucene

# Directory where game covers are stored
export GD_DATA_IMAGES=F:/gamediscovery/images
