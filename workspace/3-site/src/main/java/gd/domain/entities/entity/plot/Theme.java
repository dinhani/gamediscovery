...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.BOOK, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Theme extends ConceptEntry {
