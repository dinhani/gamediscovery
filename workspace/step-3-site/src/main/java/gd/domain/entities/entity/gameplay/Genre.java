...
@ConceptTypeDescriptor(area = ConceptTypeArea.GAMEPLAY, icon = Icon.TAG, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Genre extends ConceptEntry {
