...
@ConceptTypeDescriptor(area = ConceptTypeArea.GAMEPLAY, icon = Icon.VIDEOCAMERA, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Graphics extends ConceptEntry {
