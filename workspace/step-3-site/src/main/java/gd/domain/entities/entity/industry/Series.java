...
@ConceptTypeDescriptor(area = ConceptTypeArea.INDUSTRY, icon = Icon.GAME, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Series extends ConceptEntry {
