...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.CAR, useAsFilter = false, useAsFilterActiveByDefault = false)
public class Organization extends ConceptEntry {
