...
public class JDBCQuery {
    ...
    public JDBCQuery(JDBC jdbc, Json json) {
        this.jdbc = jdbc;
        this.json = json;
    }
    ...
    // PARAMETERS
    // =========================================================================
    public JDBCQuery attributesKeys(String... keysToAdd) {
        CollectionUtils.addAll(attributesKeys, keysToAdd);
        return this;
    }

    public JDBCQuery attributesValues(String... valuesToAdd) {
        CollectionUtils.addAll(attributesValues, valuesToAdd);
        return this;
    }

    public JDBCQuery categories(String... categoriesToAdd) {
        CollectionUtils.addAll(categories, categoriesToAdd);
        return this;
    }

    public JDBCQuery regex(String regex) {
        this.regex = regex;
        return this;
    }

    public JDBCQuery forGame() {
        this.forGame = true;
        return this;
    }
