...
@GDService
public class DataImporterCache {
    ...
    // POPULATE
    // =========================================================================
    public void addEntries(Class<? extends ConceptEntry> type, Collection<Node> nodes) {
        for (Node node : nodes) {
            addEntry(type, node);
        }
    }

    public void addEntry(Class<? extends ConceptEntry> type, Node node) {
        // id cache - main id
