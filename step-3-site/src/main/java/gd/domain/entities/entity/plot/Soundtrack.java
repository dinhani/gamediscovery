...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.MUSIC, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Soundtrack extends ConceptEntry {
