...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.BALL, useAsFilter = false, useAsFilterActiveByDefault = false)
public class SportTeam extends ConceptEntry {
