...
@ConceptTypeDescriptor(name = "Game Mechanic", area = ConceptTypeArea.PLOT, icon = Icon.TAG, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Mechanics extends ConceptEntry {
