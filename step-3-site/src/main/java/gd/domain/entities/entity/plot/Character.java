...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.PERSON, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Character extends ConceptEntry {

    // =========================================================================
    // INCOMING
    // =========================================================================
    @RelationshipDescriptor(name = "Games", relevance = RelationshipRelevance.HIGHEST)
    ...
    // OUTGOING
    // =========================================================================
    @RelationshipDescriptor(name = "Race", relevance = RelationshipRelevance.HIGH)
    @Relationship(direction = Relationship.OUTGOING, type = RelationshipType.IS)
    private SortedSet<Creature> races = TreeSetWithAttributes.create();
    ...
    public SortedSet<Creature> getRaces() {
        return races;
    }

    public void setRaces(SortedSet<Creature> races) {
        this.races = races;
    }
