...
@ConceptTypeDescriptor(area = ConceptTypeArea.GAMEPLAY, icon = Icon.CLOCK, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Duration extends ConceptEntry {
