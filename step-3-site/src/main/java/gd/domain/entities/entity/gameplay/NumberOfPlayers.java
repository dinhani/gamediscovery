...
@ConceptTypeDescriptor(area = ConceptTypeArea.INDUSTRY, icon = Icon.GAME, useAsFilter = false, useAsFilterActiveByDefault = false)
public class NumberOfPlayers extends ConceptEntry {
