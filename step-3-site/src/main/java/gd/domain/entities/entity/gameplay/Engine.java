...
@ConceptTypeDescriptor(area = ConceptTypeArea.GAMEPLAY, icon = Icon.PLATFORM, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Engine extends ConceptEntry {
