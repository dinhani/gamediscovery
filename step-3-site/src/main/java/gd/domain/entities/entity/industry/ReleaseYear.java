...
@ConceptTypeDescriptor(area = ConceptTypeArea.INDUSTRY, icon = Icon.CALENDAR, useAsFilter = true, useAsFilterActiveByDefault = false)
public class ReleaseYear extends ConceptEntry {
    ...
    // OUTGOING
    // =========================================================================
    @RelationshipDescriptor(name = "Games published", relevance = RelationshipRelevance.LOW)
