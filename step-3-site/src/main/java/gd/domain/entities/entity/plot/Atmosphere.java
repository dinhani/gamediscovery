...
@ConceptTypeDescriptor(area = ConceptTypeArea.PLOT, icon = Icon.PUZZLE, useAsFilter = true, useAsFilterActiveByDefault = false)
public class Atmosphere extends ConceptEntry {
